...
*/
        ...
        public static void Copy(bool[] srcArray, bool[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        ...
        public static void Copy(char[] srcArray, char[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        ...
        [CLSCompliant(false)]
        public static void Copy(sbyte[] srcArray, sbyte[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        [CLSCompliant(false)]
        ...
        public static void Copy(short[] srcArray, short[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        ...
        public static void Copy(int[] srcArray, int[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        ...
        public static void Copy(long[] srcArray, long[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        ...
        public static void Copy(byte[] srcArray, byte[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        ...
        [CLSCompliant(false)]
        public static void Copy(ushort[] srcArray, ushort[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        [CLSCompliant(false)]
        ...
        [CLSCompliant(false)]
        public static void Copy(uint[] srcArray, uint[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        [CLSCompliant(false)]
        ...
        [CLSCompliant(false)]
        public static void Copy(ulong[] srcArray, ulong[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        [CLSCompliant(false)]
        ...
        public static void Copy(float[] srcArray, float[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        ...
        public static void Copy(double[] srcArray, double[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
        ...
        public static void Copy(Object[] srcArray, Object[] dstArray, int length) { Copy(srcArray, 0, dstArray, 0, length); }
...
*/
        ...
        public static void Clear(bool[] array, int index, int length) {
            for (int i = 0; i < length; i++) array[index + i] = false;
        }
        public static void Clear(char[] array, int index, int length) {
            for (int i = 0; i < length; i++) array[index + i] = (char)0;
        }
        public static void Clear(sbyte[] array, int index, int length) {
        ...
        public static void Clear(ushort[] array, int index, int length) {
            for (int i = 0; i < length; i++) array[index + i] = 0;
        }
        public static void Clear(int[] array, int index, int length) {
            for (int i = 0; i < length; i++) array[index + i] = 0;
        }
        public static void Clear(uint[] array, int index, int length) {
            for (int i = 0; i < length; i++) array[index + i] = 0;
        }
        public static void Clear(long[] array, int index, int length) {
            for (int i = 0; i < length; i++) array[index + i] = 0;
        }
        public static void Clear(ulong[] array, int index, int length) {
            for (int i = 0; i < length; i++) array[index + i] = 0;
        }
        ...
        public static void Clear(Object[] array, int index, int length) {
            for (int i = 0; i < length; i++) array[index + i] = null;
        }
...
*/
        ...
        public static int BinarySearch(Object[] array, Object value, IComparer comparer) {
            if (array == null)
                throw new ArgumentNullException("array");
            int lb = 0;
        ...
        public static int BinarySearch(Object[] array, int index, int length, Object value, IComparer comparer) {
            if (array == null)
                throw new ArgumentNullException("array");
            int lb = 0;
...
*/
        ...
        public static int IndexOf(sbyte[] array, sbyte value) {
            for (int i = 0; i < array.Length; i++) if (array[i] == value) return i;
            return -1;
        }
        ...
        public static int IndexOf(ulong[] array, ulong value) {
            for (int i = 0; i < array.Length; i++) if (array[i] == value) return i;
            return -1;
        }
        ...
        public static void Sort(Object[] keys, Object[] items) {
            if (keys == null)
        ...
        public static void Sort(Object[] array, int index, int length) {
        ...
        public static void Sort(Object[] keys, Object[] items, int index, int length) {
        ...
        public static void Sort(Object[] keys, Object[] items, IComparer comparer) {
            if (keys == null)
                throw new ArgumentNullException("keys");
        ...
        public static void Sort(Object[] array, int index, int length, IComparer comparer) {
        ...
        public static void Sort(Object[] keys, Object[] items, int index, int length, IComparer comparer) {
            if (keys == null)
                throw new ArgumentNullException("keys");
            if (index < 0 || length < 0)
