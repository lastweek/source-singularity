...
//-        lemma_mul_strictly_positive_forall();
        ...
        calc ==> {
            power2(ac-1) <= I(A) < power2(ac);
                {
                    lemma_mul_left_inequality(power2(32 * w), power2(ac-1), I(A));
                    lemma_mul_left_inequality(power2(32 * w), I(A), power2(ac));
                }
            power2(32*w) *  power2(ac-1) <= power2(32*w) *  I(A) < power2(32*w) *  power2(ac);
                {
                    lemma_power2_adds(32*w, ac-1);
                    lemma_mul_is_commutative(power2(32*w), I(A));
                    lemma_power2_adds(32*w, ac);
                }
            power2(32*w+ac-1) <= I(A) *  power2(32*w) < power2(ac+32*w);
                //- defn rc
            power2(rc-1) <= I(A) *  power2(32*w) < power2(rc);
